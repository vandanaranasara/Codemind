...
#         # Sample test case
#         test_cases = [{"input": problem.sample_input, "expected": problem.sample_output, "type": "Sample"}]

#         # Hidden test cases from JSON
...
#                 all_passed = False
#                 results.append({"type": tc["type"], "status": "Timeout", "input": tc["input"]})
...
#         # Prepare test cases
#         test_cases = [
#             {"input": problem.sample_input, "expected": problem.sample_output, "type": "Sample"}
#         ]

#         # Hidden test cases from JSON
#         if problem.hidden_test_cases:
#             try:
#                 hidden_cases_json = json.loads(problem.hidden_test_cases)
#                 hidden_tests = hidden_cases_json.get("tests", [])
#                 for c in hidden_tests:
#                     test_cases.append({
#                         "input": c["input"].replace("\\n", "\n"),
#                         "expected": c["output"].replace("\\n", "\n"),
#                         "type": "Hidden"
